...
const RestaurantMediumCart = ({name, images: {logo}, time, distance, tags}) => {
  return (
    <View style={styles.container}>
      <View>
        <Image source={{uri: StaticServiceImage.getLogo(logo)}} style={styles.posterStyle} />
      </View>
...
export default RestaurantMediumCart;
